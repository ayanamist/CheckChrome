...
do
    ...
    sed -i "s|{{${i}-Version}}|$version|g" tmp/chrome.txt
    sed -i "s|{{${i}-SHA256}}|$sha256|g" tmp/chrome.txt
    sed -i "s|{{${i}-dl-main}}|$dl|g" tmp/chrome.txt
    sed -i "s|{{${i}-dl-alternative}}|$dl_alt|g" tmp/chrome.txt
    sed -i "s|{{${i}-dl-cache}}|$dl_cache|g" tmp/chrome.txt
    sed -i "s|{{${i}-Size}}|$size_raw|g" tmp/chrome.txt
done